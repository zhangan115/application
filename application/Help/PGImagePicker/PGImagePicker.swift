...
class PGImagePicker: PGBaseViewController {
    ...
    fileprivate let windowLevel: UIWindow.Level!
    ...
    private func setupCollectionView() {
        ...
        flowLayout.sectionInset = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: imageViewSpace)
        var bounds = self.view.bounds
        bounds.size.width += imageViewSpace
...
extension PGImagePicker: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.scrollView.isDelete = self.isDelete
